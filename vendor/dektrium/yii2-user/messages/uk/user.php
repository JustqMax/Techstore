...
return array (
    '#' => '',
    'Are you sure you want to switch to this user for the rest of this Session?' => 'Ви впевнені, що хочете перемкнутися на цього користувача до кінця цього сеансу?',
    'Are you sure?' => 'Ви впевнені?',
    'Are you sure? There is no going back' => 'Чи впевнені ви? Шляху назад немає.',
    'Become this user' => 'Стати цим користувачем.',
    'Delete account' => 'Видалити аккаунт.',
    'Error while trying to generate new password' => 'Помилка під час спроби згенерувати новий пароль.',
    'Generate and send new password to user' => 'Створіть та надішліть новий пароль користувачеві.',
    'Impersonate user is disabled in the application configuration' => 'Уявлення про вимкненого користувача вимкнено в конфігурації програми.',
    'In order to finish your registration, we need you to enter following fields' => 'Для того, щоб закінчити реєстрацію, нам потрібно ввести наступні поля.',
    'It will be deleted forever' => 'Його буде видалено назавжди.',
    'Last login' => 'Останній логін.',
    'Never' => 'Ніколи.',
    'New Password has been generated and sent to user' => 'Новий пароль створено та надіслано користувачеві.',
    'New rule' => 'Нове правило.',
    'Not found' => 'Не знайдено.',
    'Once you delete your account, there is no going back' => 'Після того, як ви видалите свій обліковий запис, повернення назад не буде.',
    'Password generation is not possible for admin users' => 'Генерація пароля неможлива для користувачів адміністратора.',
    'Password is not necessary because the module is in DEBUG mode.' => 'Пароль не потрібний, оскільки модуль перебуває в режимі DEBUG.',
    'Please be certain' => 'Будьте впевнені.',
    'Registration on this website is disabled' => 'Реєстрація на цьому веб-сайті відключена.',
    'Rules' => 'Правила.',
    'Time zone' => 'Часовий пояс.',
    'Time zone is not valid' => 'Часовий пояс не дійсний.',
    'We have generated a password for you' => 'Ми створили для вас пароль.',
    'Your account has been blocked.' => 'Ваш рахунок заблоковано.',
    'Your account has been completely deleted' => 'Ваш обліковий запис повністю видалено.',
    'Your account has been created and a message with further instructions has been sent to your email' => 'Ваш обліковий запис створено, а на електронну адресу надіслано повідомлення з подальшими інструкціями.',
    'Your account on {0} has a new password' => 'Ваш обліковий запис на {0} має новий пароль.',
    'Your password on {0} has been changed' => 'Ваш пароль на {0} змінено.',
    '(not set)' => '(не задано)',
    ...
    'If you cannot click the link, please try pasting the text into your browser' => 'Якщо з яких-небудь причин посилання не працює, вставте наступну адресу в стрічку браузера',
    'If you did not make this request you can ignore this email' => 'P.S. Якщо ви не відправляли цей запит, ігноруйте цей лист та удаліть його.',
    ...
    'Your account on {0} has been created' => 'Ваш аккаунт на сайті "{0}" був успішно створений',
